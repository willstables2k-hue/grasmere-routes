"""Cost-model parity tests — fixtures are the canonical source of truth
for both the optimiser objective and the £ figures the UI displays."""

from __future__ import annotations

import pytest

from grasmere_routes.cost_model import (
    KM_PER_MILE,
    UK_GALLON_L,
    CostParams,
    allocate_stop_share,
